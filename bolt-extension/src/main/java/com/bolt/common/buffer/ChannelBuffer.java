...
public final class ChannelBuffer {
    ...
    public ChannelBuffer(ByteBuf buffer) {
        this.buffer = buffer;
    }
    ...
    public ChannelBuffer copy(int index, int length) {
        return new ChannelBuffer(buffer.copy(index, length));
    }
    ...
    public ChannelBuffer copy() {
        return new ChannelBuffer(buffer.copy());
    }
    ...
    public ChannelBuffer readBytes(int length) {
        return new ChannelBuffer(buffer.readBytes(length));
    }
